...
class ElectromagnetismSolver:
    ...
    def create_widgets(self):
        ...
        tk.Label(self.master, text="Select Problem Type:", font=("Arial", 12)).pack(
            pady=10
        )
    ...
    def add_variable_input(self):
        ...
        var_dropdown = ttk.Combobox(
            row_frame, values=var_options, state="readonly", width=20
        )
        ...
        remove_button = tk.Button(
            row_frame, text="X", command=lambda: row_frame.destroy()
        )
        ...
        try:
            ...
            if result:
                ...
                messagebox.showinfo(
                    ...
                    "Not enough variables to solve the problem.",
                )
    ...
    def solve_magnetic_force(self):
        ...
        if "Magnetic Force" not in self.variables:
            if all(
                ...
                for var in ["Charge", "Velocity", "Magnetic Field"]
            ):
                charge = self.variables["Charge"]
